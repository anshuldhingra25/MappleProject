    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (MyPreferences.getActiveInstance(SpleshActivity.this).getIsLoggedIn()) {
                    ...
                    if (mNotificationdata.equalsIgnoreCase("Your account has been deactivated, by admin so please contact to admin for any query.")) {
                        ...
                        builder.setMessage("Sorry your account has deactivated. Please contact to admin.")
                                ...
                                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        dialog.dismiss();
                                        // String userId = MyPreferences.getActiveInstance(SpleshActivity.this).getUserId();
                        ...
                        builder.setMessage("Your account has been deleted.")
                                ...
                                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        dialog.dismiss();
                                        MyPreferences.getActiveInstance(SpleshActivity.this).setUserId(" ");
                                        MyPreferences.getActiveInstance(SpleshActivity.this).setIsLoggedIn(false);
                        ...
                        mainIntent = new Intent(SpleshActivity.this, MainActivity.class);
                    ...
                    Intent i = new Intent(SpleshActivity.this, WelComeActivity.class);
                    startActivity(i);
                    finish();
                }
