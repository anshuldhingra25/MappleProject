...
public class Disclamer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_avlableCredit.setText(MyPreferences.getActiveInstance(Disclamer.this).getCreditbalance());
        ...
        ln_creditbalance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(Disclamer.this, AvlableBlance.class);
                startActivity(in);
            }
        });

        prgDialog = new ProgressDialog(Disclamer.this);
        prgDialog.setMessage("Please wait...");
        prgDialog.setCancelable(false);

        if (CommanMethod.isOnline(Disclamer.this)) {
            RequestParams params = new RequestParams();
            termCondtionsWebServices(params);
        } else {

            CommanMethod.showAlert("Network Error,Please try again", Disclamer.this);
        }
                ...
                try {
                    ...
                    if (respcode.equals("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if(textslug.equalsIgnoreCase("disclaimer"))
                            {
                        ...
                        CommanMethod.showAlert(respMessage,Disclamer.this);
                    } else {
