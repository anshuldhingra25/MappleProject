package com.findpackers.android.aap.popupwindow;
...
public class AdvancePopupWindow extends PopupWindow {
    ...
    public AdvancePopupWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AdvancePopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public AdvancePopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public AdvancePopupWindow() {
        super();
    }

    public AdvancePopupWindow(View contentView) {
        super(contentView);
    }

    public AdvancePopupWindow(int width, int height) {
        super(width, height);
    }

    public AdvancePopupWindow(View contentView, int width, int height) {
        super(contentView, width, height);
    }

    public AdvancePopupWindow(View contentView, int width, int height, boolean focusable) {
