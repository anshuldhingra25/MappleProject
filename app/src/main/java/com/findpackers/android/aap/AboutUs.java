...
public class AboutUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_avlableCredit.setText(MyPreferences.getActiveInstance(AboutUs.this).getCreditbalance());
        ...
        ln_creditbalance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(AboutUs.this, AvlableBlance.class);
                startActivity(in);
            }
        });

        prgDialog = new ProgressDialog(AboutUs.this);
        prgDialog.setMessage("Please wait...");
        prgDialog.setCancelable(false);

        if (CommanMethod.isOnline(AboutUs.this)) {
            RequestParams params = new RequestParams();
            termCondtionsWebServices(params);
        } else {

            CommanMethod.showAlert("Network Error,Please try again", AboutUs.this);
        }
                ...
                try {
                    ...
                    if (respcode.equals("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if(textslug.equalsIgnoreCase("about-us"))
                            {
                        ...
                        CommanMethod.showAlert(respMessage,AboutUs.this);
                    } else {
