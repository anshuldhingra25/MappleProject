...
public class ContactUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_avlableCredit.setText(MyPreferences.getActiveInstance(ContactUs.this).getCreditbalance());
        ...
        ln_creditbalance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(ContactUs.this, AvlableBlance.class);
                startActivity(in);
            }
        });

        prgDialog = new ProgressDialog(ContactUs.this);
        prgDialog.setMessage("Please wait...");
        prgDialog.setCancelable(false);

        if (CommanMethod.isOnline(ContactUs.this)) {
            RequestParams params = new RequestParams();
            termCondtionsWebServices(params);
        } else {

            CommanMethod.showAlert("Network Error,Please try again", ContactUs.this);
        }
                ...
                try {
                    ...
                    if (respcode.equals("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if(textslug.equalsIgnoreCase("contact-us"))
                            {
                        ...
                        CommanMethod.showAlert(respMessage,ContactUs.this);
                    } else {
