...
public class TermsAndConditions extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_avlableCredit.setText(MyPreferences.getActiveInstance(TermsAndConditions.this).getCreditbalance());
        ...
        ln_creditbalance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(TermsAndConditions.this, AvlableBlance.class);
                startActivity(in);
            }
        });

        prgDialog = new ProgressDialog(TermsAndConditions.this);
        prgDialog.setMessage("Please wait...");
        prgDialog.setCancelable(false);

        if (CommanMethod.isOnline(TermsAndConditions.this)) {
            RequestParams params = new RequestParams();
            termCondtionsWebServices(params);
        } else {

            CommanMethod.showAlert("Network Error,Please try again", TermsAndConditions.this);
        }
                ...
                try {
                    ...
                    if (respcode.equals("200")) {
                       ...
                       // CommanMethod.showAlert(respMessage,HowItWorkActivity.this);
                        ...
                        CommanMethod.showAlert(respMessage,TermsAndConditions.this);
                    } else {
