...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    public static List<KeyPairBoolData> items;
    ...
    public static Set staticmselectdcity = new HashSet();
    public static Set cancelitem = new HashSet();
    ...
    public boolean performClick() {
        ...
        title.setTextColor(Color.parseColor("#4ab9cf"));
        title.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20);
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
       // lp.setMargins(30, 30, 30, 30);

        lp.setMargins(0, 35, 0, 35);
        title.setPadding(0,35,0,35);

        title.setLayoutParams(lp);
        title.setText(spinnerTitle);
        ...
        System.out.println("performClick   :"+""+items);
        ...
        ad.getWindow().setLayout(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT); //Controlling width and height.
        ...
        pbutton.setBackgroundColor(Color.parseColor("#4ab9cf"));
        pbutton.setTextColor(Color.WHITE);

        Button nbutton = ad.getButton(DialogInterface.BUTTON_NEGATIVE);
        nbutton.setBackgroundColor(Color.parseColor("#4ab9cf"));
 ...
 public void setItemsclear(List<KeyPairBoolData> items) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
          ...
          // final int backgroundColor = (position%2 == 0) ? R.color.list_even : R.color.list_odd;
           //convertView.setBackgroundColor(ContextCompat.getColor(getContext(), backgroundColor));
            ...
            System.out.println("call on item set "+""+staticmselectdcity.size()+""+staticmselectdcity);
                if (staticmselectdcity.contains(data.getName())) {
                    data.setSelected(false);
                    staticmselectdcity.remove(data.getName());
               ...
               if(cancelflag) {
                    ...
                    System.out.println("call on item set  cancelitem " + "" + cancelitem.size() + "" + cancelitem);
                    if (cancelitem.contains(data.getName())) {
                        data.setSelected(false);
                        cancelitem.remove(data.getName());
